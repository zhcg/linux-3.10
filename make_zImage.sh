...
if [ ! -e ./.config ] ; then
	if [ "$PHONE_BOARD_VERSION" = "YL8150S_EVB" ] ; then	
		...
		echo "Select ZEUS board version is v1.0"
		make lc1860_zeus_defconfig
		...
		M9206_V1_0, LX70A_V1_0,K706_V1_0,YONGDA_V1_0, FOURMODE_V1_0, LC1860_PHONE, SMARTMODULE_V1_0, LC1860_ZEUS"
